...
int main()
{
    ...
    //проверяем на 4 одинаковых, стоящих в 1 разряде
    if (s.length() > 3)
    {
        for (int i = 0; i < s.length() - 3; ++i)
        {
            ...
            {
                cerr << "Введено неверное число (по правилу записи римских чисел, рядом не могут стоять 4 цифры одинакового разряда). Перезапустите программу и повторите ввод.";
                return 0;
            }
        }
    }
